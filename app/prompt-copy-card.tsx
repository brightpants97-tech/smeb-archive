...
1. 유튜브+SOOP 통합 키워드 10가지: 이달 전체 영상 기반 핵심 키워드 10개, 각 키워드마다 관련 영상 주요 상황 설명 (링크 참고)
2. 유튜브와 SOOP에서 이번달 주된 콘텐츠
3. swot 분석
4. swot을 참고한 콘텐츠 5가지 추천(생방송에서 가능한 현실성 있는 콘텐츠, 각 추천마다 SWOT 어느 요소에 근거한 추천인지 + 왜 이 콘텐츠가 지금 스맵에게 맞는지 이유 구체적으로)
