...
8. 이달 영상 티어표 (S~C): 유튜브+SOOP 전체 영상을 조회수·소재·반응성 기준으로 S/A/B/C 티어로 분류하고 각 이유 한 줄씩
9. 이달 콜라보 케미 랭킹: 함께 등장한 스트리머·유튜버 전원 나열 후 케미·시너지 기준 1위 선정 및 이유
10. 이달 콘텐츠 장르 비율: 게임·일상·합방·여행 등 카테고리별 비율을 퍼센트로 정리 (예: 게임 40% / 합방 30% / 일상 30%)
11. 한 문장으로 정리하는 이번 달(명언)`;
