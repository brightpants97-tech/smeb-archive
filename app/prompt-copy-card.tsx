...
📌 출력 형식:
- 방송에서 시청자와 함께 읽는 월말 평가 콘텐츠용이야
- 각 항목은 결과 바로 말하지 말고 한 줄 빌드업 후 결과 공개하는 식으로 써줘
- 말투는 가볍고 재밌게, 시청자가 채팅 칠 만한 포인트마다 💬 표시해줘
- 티어표·랭킹은 꼴찌부터 1위 순서로 발표
- 각 섹션 끝에 시청자 참여 유도 멘트 1줄씩 넣어줘
- 전체 흐름이 시상식처럼 느껴지게 구성해줘`;
