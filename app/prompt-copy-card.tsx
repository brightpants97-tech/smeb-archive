...
10. 한 문장으로 정리하는 이번 달(명언)

📌 출력 형식:
- 방송에서 시청자와 함께 읽는 월말 리뷰 기사 형식으로 작성해줘
- 전체를 하나의 매거진 기사처럼 구성: 커버 헤드라인 → 각 섹션 소제목 → 본문
- 각 섹션은 [ 📰 소제목 ] 형태로 구분해줘
- 소제목은 신문 헤드라인처럼 임팩트 있게 (예: "이달의 MVP는 바로 이 영상")
- 본문은 가볍고 재밌는 말투, 핵심은 굵게 강조
- 티어표·랭킹은 꼴찌부터 1위 순서로 발표
- 시청자가 채팅 칠 만한 포인트마다 💬 표시
- 각 섹션 끝에 시청자 참여 유도 한 줄
- 마지막은 명언으로 마무리되는 에디터 마감 코멘트 느낌으로`;
