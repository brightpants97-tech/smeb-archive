...
- 전체를 실제 신문 기사처럼 딱딱하고 진지한 문체로 작성해줘 (경어체, ~했다 / ~으로 분석된다 / ~인 것으로 나타났다)
- 구성: 날짜·매체명 → 리드 헤드라인 → 부제 → 섹션별 소제목+본문
- 각 섹션 소제목은 [ ] 안에 넣고 한 줄 리드문으로 시작
- 핵심 수치·이름은 따옴표나 강조로 처리
- 티어표·랭킹은 꼴찌부터 1위 순서로 발표
- 각 섹션 끝에 케케단을 향한 기자 논평 한 줄 (💬 표시)
- 마지막은 명언을 인용구 형식으로 마무리`;
