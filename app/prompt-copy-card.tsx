...
1. 유튜브+SOOP 통합 키워드 10가지 (각 키워드 관련 영상 한 줄 설명)
2. 이번달 주된 콘텐츠
3. SWOT 분석
4. SWOT 기반 생방송 콘텐츠 5가지 추천 (각 추천마다 근거 요소 + 이유)
5. 이번 달 등장한 스트리머·유튜버 전체 / 베스트 케미 1명
6. 최고 조회수 유튜브·SOOP 영상 각 1개 — 인기 이유 분석
7. 영상 티어표 S~C (조회수·소재·반응성 기준, 이유 한 줄씩)
8. 콜라보 케미 랭킹 (전원 나열 후 1위 선정)
9. 콘텐츠 장르 비율 (카테고리별 %)
10. 이번 달 한 문장 결론
