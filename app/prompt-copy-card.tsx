...
위 데이터를 기반으로 아래 10가지를 분석해줘 (기승전결 순서대로):
...
[승] 어떻게 됐나
4. 영상 티어표 S~C (조회수·소재·반응성 기준, 이유 한 줄씩)
5. 최고 조회수 유튜브·SOOP 영상 각 1개 — 인기 이유 분석
6. 이번 달 등장한 스트리머·유튜버 전체

[전] 분석하면
7. 콜라보 케미 랭킹 (전원 나열 후 1위 선정)
8. SWOT 분석

[결] 그래서
9. SWOT 기반 생방송 콘텐츠 5가지 추천 (각 추천마다 근거 요소 + 이유)
10. 이번 달 한 문장 결론

📌 출력 형식:
- 스맵(SMEB)의 시청자 애칭은 '케케단'이야, 시청자 언급 시 케케단으로 불러줘
- 문체: 실제 신문 기사체 (~했다 / ~으로 분석됐다 / ~인 것으로 나타났다)
- 과장·추측·판타지적 표현 금지, 제공된 데이터 안에서만 현실적으로 작성
