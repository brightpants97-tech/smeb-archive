  ...
  return (
    <div style={{background:BG,minHeight:'100vh',color:'#fff',fontFamily:'system-ui,sans-serif'}}>
      <style>{`
        ...
        .lock-btn{opacity:0.22;filter:grayscale(1);transition:all 0.15s}
        .lock-btn:hover{opacity:0.6!important}
        .lock-btn.active{opacity:1!important;filter:none!important}
      `}</style>
            ...
            <div key={pos} style={{
              ...
              <div style={{position:'relative',display:'flex',alignItems:'center'}}>
                ...
                <input value={names[i][0]} onChange={e=>setName(i,0,e.target.value)} onKeyDown={e=>e.key==='Enter'&&allFilled&&roll()} placeholder="이름"
                  style={{width:'100%',background:'transparent',border:'none',padding:'15px 14px 15px 28px',color:'#fff',fontSize:'0.95rem',fontWeight:700}} />
              </div>
